# Generated by Django 4.2.5 on 2024-03-04 05:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('firstapp', '0037_alter_order_status'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='firstapp.thread')),
